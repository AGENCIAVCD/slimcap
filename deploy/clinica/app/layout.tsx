...
export const metadata: Metadata = {
  metadataBase: new URL("https://slimcap.com.br"),
  applicationName: "Slimcap",
  title: {
    default: "Slimcap | Método e cuidado capilar",
    template: "%s | Slimcap",
  },
  description:
    "Conheça o Método Slimcap, encontre seu protocolo e cuide do cabelo em casa com orientação especializada.",
